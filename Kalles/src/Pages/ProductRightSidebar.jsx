...
const ProductRightSidebar = () => {
  ...
  return (
    <div className="w-full bg-white font-sans text-zinc-900">
      ...
      {/* Main Content Layout - Order: Image | Details | Sidebar */}
      <div className="max-w-[1400px] mx-auto px-6 py-10">
        <div className="grid grid-cols-1 md:grid-cols-[350px_1fr] lg:grid-cols-[400px_1fr_280px] gap-10 items-start">
          
          {/* LEFT: MAIN GALLERY (STICKY) */}
          <div 
            className="sticky top-24 overflow-hidden group relative bg-zinc-50 cursor-crosshair h-fit border border-zinc-100"
          ...
          <div className="flex flex-col gap-6 relative">
            ...
            <div className="bg-[#fdf9f9] border border-[#fdeeee] rounded-md p-6 py-4 flex flex-col items-center gap-4">
               ...
               <div className="flex gap-8 text-center">
                  ...
                  <div className="flex flex-col">
                     <span className="text-[28px] font-black text-zinc-900 leading-none">14</span>
                     <span className="text-[11px] text-zinc-500 font-bold uppercase tracking-widest mt-2">hours</span>
                  </div>
                  <div className="flex flex-col">
                     <span className="text-[28px] font-black text-zinc-900 leading-none">34</span>
                     <span className="text-[11px] text-zinc-500 font-bold uppercase tracking-widest mt-2">minutes</span>
                  </div>
                  <div className="flex flex-col">
                     <span className="text-[28px] font-black text-zinc-900 leading-none">23</span>
            ...
            <div className="flex flex-wrap items-center gap-4">
              ...
              <div className="flex gap-2">
                 <button 
                  ...
                  className={`w-11 h-11 border-2 border-zinc-100 rounded-full flex items-center justify-center transition-all ${isFavorite ? 'bg-[#67cfde] text-white border-[#67cfde]' : 'text-zinc-600 hover:bg-[#67cfde] hover:text-white hover:border-[#67cfde] group'}`}
                >
          ...
          <aside className="w-full lg:w-[280px] space-y-12">
