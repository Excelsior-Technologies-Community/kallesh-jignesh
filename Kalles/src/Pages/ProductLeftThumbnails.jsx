      ...
      <div className="max-w-[1200px] mx-auto px-6 py-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="flex gap-4">
            ...
            <div className="hidden md:flex flex-col gap-3 w-[100px]">
              {productImages.map((img, idx) => (
                <div 
                  ...
                  className={`aspect-[3/4] cursor-pointer border-2 transition-all animate-rotate-in-manual ${activeIndex === idx ? 'border-zinc-900 shadow-md scale-105' : 'border-zinc-100 hover:border-zinc-300'}`}
            ...
            {/* main gallery */}
            <div 
              className="flex-1 overflow-hidden group relative bg-zinc-50 cursor-crosshair h-fit self-start animate-fade-in-up-manual"
