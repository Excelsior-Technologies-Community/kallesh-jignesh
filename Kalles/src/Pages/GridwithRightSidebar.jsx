        ...
        <div className="group relative overflow-hidden flex flex-col items-center">
            <div className="w-full aspect-[3/4] relative overflow-hidden bg-[#f6f6f6] mb-4">
                ...
                <div className="absolute top-1 right-1 flex flex-col gap-2 z-10">
                    {product.stock <= 0 && (
                        <div className="w-9 h-9 bg-gray-500 text-white rounded-full flex items-center justify-center text-[10px] uppercase font-bold text-center leading-tight shadow-sm">Sold<br />Out</div>
                    )}
                    {Boolean(hasDiscount) && (
        ...
        <div className="w-full bg-white">
            ...
            <div className="container mx-auto px-4 lg:px-8 max-w-[1240px] pb-20">
                <div className="flex flex-col lg:flex-row gap-10">
                    {/* Main Content Area (Now first in DOM for mobile, or but on left because of flex order if needed) */}
...
export default GridwithRightSidebar;
