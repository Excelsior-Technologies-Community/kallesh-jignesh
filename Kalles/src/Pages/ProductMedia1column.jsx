...
const ProductMedia1column = () => {
  ...
  const productImages = [
    'https://kalles-5.myshopify.com/cdn/shop/files/20048517-3.jpg?v=1717405177&width=823',
    'https://kalles-5.myshopify.com/cdn/shop/files/20048517-2.jpg?v=1717405177&width=823',
    'https://kalles-5.myshopify.com/cdn/shop/files/20048517-1-green.jpg?v=1717405177&width=823',
    'https://kalles-5.myshopify.com/cdn/shop/files/20048517-4.jpg?v=1718704129&width=823'
  ];

  const product = {
    id: 'jersey-puff-sleeve-static',
    name: "Jersey Puff Sleeve Top",
    price: 18.00,
      ...
      <div className="border-b border-zinc-100">
        <div className="max-w-[1400px] mx-auto px-6 py-4 flex items-center justify-between">
          <nav className="flex items-center gap-2 text-[14px] text-zinc-500">
            ...
            <span className="hover:text-zinc-900 cursor-pointer">Jersey Puff Sleeve Top</span>
          </nav>
        ...
        <div className="flex flex-col lg:flex-row gap-12 items-start">
          ...
          <div className="w-full lg:w-[40%] space-y-4">
             {productImages.map((img, idx) => (
                <div 
                  key={idx} 
                  className="w-full overflow-hidden cursor-crosshair relative border border-transparent hover:border-zinc-100 animate-rotate-in-manual"
                ...
                >
                  ...
                  {zoomData.active && zoomData.index === idx && (
                    <div 
                      className="absolute pointer-events-none bg-black/10 border border-white/40 ring-1 ring-black/5"
                      style={{
                        width: '160px',
                        height: '160px',
                        left: `${zoomData.x}%`,
          ...
          <div className="w-full lg:w-[60%] lg:sticky lg:top-10 relative">
            {/* Zoom Preview Window (Appears over details on hover) */}
            {zoomData.active && (
              <div 
                className="absolute top-0 left-0 w-[500px] h-[500px] bg-white z-[100] border border-zinc-100 shadow-2xl pointer-events-none hidden lg:block overflow-hidden"
                style={{
                  backgroundImage: `url(${productImages[zoomData.index]})`,
            ...
            <div className={`flex flex-col gap-6 transition-opacity duration-300 ${zoomData.active ? 'opacity-0' : 'opacity-100'}`}>
              <div>
                <h1 className="text-[24px] md:text-[32px] font-bold tracking-tight mb-2">Jersey Puff Sleeve Top</h1>
                <div className="text-[20px] md:text-[24px] text-zinc-500 font-medium">$18.00</div>
              </div>
              ...
              <div className="space-y-4">
                <div className="text-[13px] font-bold uppercase tracking-wider">
                  COLOR: <span className="font-normal text-zinc-500 ml-1">GREEN</span>
                </div>
                <div className="flex gap-3">
                   <div className="w-8 h-8 rounded-full border-2 border-zinc-900 bg-[#D4E157] cursor-pointer ring-2 ring-offset-2 ring-transparent hover:ring-zinc-900 transition-all"></div>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-4 py-4 border-b border-zinc-100">
                  ...
                  <div className="space-y-1 text-[14px]">
                     <div><span className="text-zinc-900">Availability:</span> <span className="text-zinc-500 italic">In stock</span></div>
                     <div><span className="text-zinc-900">SKU:</span></div>
                     <div><span className="text-zinc-900">Categories:</span> <span className="text-zinc-500">All, Dress, Women</span></div>
                     <div className="flex items-start gap-1">
                       <span className="text-zinc-900 flex-shrink-0">Tags:</span> 
                       <span className="text-zinc-500 italic">Color Green, Price $7–$50, Vendor Monki, women</span>
                     </div>
                  </div>

              {/* Social Sharing */}
              <div className="flex items-center gap-5 py-2">
                <button className="text-zinc-400 hover:text-zinc-900 transition-colors"><Facebook size={18} /></button>
                <button className="text-zinc-400 hover:text-zinc-900 transition-colors"><Twitter size={18} /></button>
        ...
        <div className="max-w-[1200px] mx-auto px-6">
          ...
          <div className="max-w-[1000px] mx-auto">
            ...
            {activeTab === 'Additional Information' && (
              <div className="animate-fade-in border border-zinc-200 rounded-sm overflow-hidden">
                <table className="w-full border-collapse">
                  <tbody>
                    <tr className="border-b border-zinc-200 last:border-0">
                      <th className="w-[150px] md:w-[200px] text-left py-4 px-6 font-bold text-zinc-900 uppercase tracking-widest text-[12px] border-r border-zinc-200 bg-zinc-50/50">Color</th>
                      <td className="py-4 px-6 text-zinc-500 text-[14px]">Green</td>
                    </tr>
                    <tr className="border-b border-zinc-200 last:border-0">
                      <th className="w-[150px] md:w-[200px] text-left py-4 px-6 font-bold text-zinc-900 uppercase tracking-widest text-[12px] border-r border-zinc-200 bg-zinc-50/50">Size</th>
                      <td className="py-4 px-6 text-zinc-500 text-[14px]">S, M, L</td>
                    </tr>
                  </tbody>
                </table>
              </div>
        ...
        <div className="relative group/slider">
          <div ref={sliderRef} className="flex gap-6 overflow-x-auto scroll-smooth no-scrollbar scroll-snap-x mandatory py-4">
            {[
              ...
              { id: 4, name: 'Summer Shorts', price: 30.00, image1: 'https://kalles-5.myshopify.com/cdn/shop/files/p24-11_ec0dcf2b-dcc4-48cf-8b3e-71c6945984db.jpg?v=1717404493&width=940', size: 'S, M, L' },
              ...
              { id: 9, name: 'Sport Sneaker', price: 35.00, image1: 'https://kalles-5.myshopify.com/cdn/shop/files/ezgif.com-webp-to-jpg_e77ecbaa-4aa5-41b7-ba2f-f057f4ae6aa7.jpg?v=1717403734&width=720', size: '7, 8, 9, 10' },
...
export default ProductMedia1column;
