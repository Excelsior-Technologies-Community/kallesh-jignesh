...
const ProductMediaStacked = () => {
  ...
  const productImages = [
    'https://kalles-5.myshopify.com/cdn/shop/files/1_2726330f-2366-4837-83a9-5f9d164fa813.png?v=1717404502&width=1206',
    'https://kalles-5.myshopify.com/cdn/shop/files/1-2_474fb1b8-5c0e-4113-aac0-862a1845a0f8.png?v=1717404502&width=1206',
    'https://kalles-5.myshopify.com/cdn/shop/files/1-1_78304c39-2494-42dc-ba95-d960778aa31a.png?v=1717404502&width=1346'
  ];

  const product = {
    id: 'simple-skin-tshirt-static',
    ...
    <div className="w-full bg-white font-sans text-zinc-900">
      ...
      <div className="border-b border-zinc-100">
        <div className="max-w-[1400px] mx-auto px-6 py-4 flex items-center justify-between">
          <nav className="flex items-center gap-2 text-[14px] text-zinc-500">
            ...
            <ChevronRight size={14} className="text-zinc-300" />
            <span className="hover:text-zinc-900 cursor-pointer">Simple Skin T-shirt</span>
          </nav>
      ...
      <div className="max-w-[1200px] mx-auto px-6 py-10">
        <div className="flex flex-col lg:flex-row gap-12 items-start">
             ...
             >
               <img 
                 ...
                 className={`w-full h-auto object-cover transition-transform duration-200 ease-out ${
                   zoomData.active && zoomData.index === 0 ? 'scale-[2]' : 'scale-100'
                 }`}
                 style={
                   zoomData.active && zoomData.index === 0 
                ...
                {productImages.slice(1).map((img, idx) => (
                  ...
                  >
                    <img 
                      ...
                      alt={`Product ${idx + 1}`} 
                      className={`w-full h-auto object-cover transition-transform duration-200 ease-out ${
                        zoomData.active && zoomData.index === (idx + 1) ? 'scale-[2]' : 'scale-100'
                      }`}
                      style={
                        zoomData.active && zoomData.index === (idx + 1) 
                          ? { transformOrigin: `${zoomData.x}% ${zoomData.y}%` } 
                          : {}
                      }
                    />
          ...
          <div className="w-full lg:w-[58%] lg:sticky lg:top-10 relative">
            <div className="flex flex-col gap-6">
              <div>
                <h1 className="text-[24px] md:text-[32px] font-bold tracking-tight mb-2">Simple Skin T-shirt</h1>
                <div className="text-[20px] md:text-[24px] text-zinc-500 font-medium">$56.00</div>
              </div>
              ...
              <div className="space-y-1 text-[13px] pt-4 border-t border-zinc-50">
                 ...
                 <div><span className="text-zinc-400">Tags:</span> <span className="text-zinc-600 italic">Price $50-$150, Vendor Kalles, women</span></div>
              </div>
          ...
          <div className="max-w-[1000px] mx-auto">
                ...
                <table className="w-full border-collapse">
                  <tbody>
                    <tr className="border border-zinc-100">
                      <th className="w-[150px] md:w-[200px] text-left py-4 px-6 font-bold text-zinc-900 text-[13px] border-r border-zinc-100">Size</th>
                      <td className="py-4 px-6 text-zinc-500 text-[13px]">S, M, L, XL</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            {activeTab === 'Custom tab' && (
              <div className="animate-fade-in flex flex-col items-center">
                 ...
                 <p className="text-[13px] text-zinc-500 italic">LT01: 70% wool, 15% polyester, 10% polyamide, 5% acrylic 900 Grms/mt</p>
              </div>
            )}
          </div>
        </div>
...
export default ProductMediaStacked;
