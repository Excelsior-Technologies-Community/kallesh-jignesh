        ...
        <div className="flex flex-col border p-5 justify-center items-center md:flex-row gap-8 border-b border-gray-200 last:border-0 group/card">
            ...
            <div className="w-full md:w-[220px] shrink-0 flex flex-col gap-3 pt-2">
                ...
                <div className="flex items-center w-full">
                    ...
                    {/* Add Button */}
                    <button
                        onClick={() => addToCart(product, quantity, product.size ? String(product.size).split(',')[0].trim() : '')}
                        className={`flex-1 h-[45px] text-white text-[14px] font-bold rounded-r-full transition-colors whitespace-nowrap px-4 tracking-wide ${product.stock <= 0 ? 'bg-gray-400 cursor-not-allowed' : 'bg-[#56cfe1] hover:bg-[#3ac3d6]'}`}
...
const FullWidth = () => {
    ...
    return (
        <div className="w-full">
            ...
            {/* Main Content */}
            <div className="container mx-auto px-4 lg:px-8 max-w-[1495px] pb-20">
                {/* Toolbar */}
