...
const ThumbnailcarouselR = () => {
  ...
  const productImages = [
    'https://kalles-5.myshopify.com/cdn/shop/files/nlota2087710739_q1_2-0_8077af1c-2697-44de-bd4e-42cad31a16b3.jpg?v=1717404511&width=1000',
    'https://kalles-5.myshopify.com/cdn/shop/files/nlota2087710739_q2_2-0_8564d457-e030-45da-9ea5-a3aab2c582de.jpg?v=1717404511&width=1000',
    'https://kalles-5.myshopify.com/cdn/shop/files/nlota2087710739_q3_2-0_ee606528-f197-4703-b1d0-4baed30a1d1d.jpg?v=1717404511&width=1000',
    'https://kalles-5.myshopify.com/cdn/shop/files/nlota2087710739_q5_2-0_d85ec457-e9b4-4ddb-9f19-7ab1840dcf02.jpg?v=1717404511&width=1000'
  ];

  const product = {
    id: 'ridley-high-waist-static-r',
    ...
    <div className="w-full bg-white font-sans text-zinc-900">
      ...
      <div className="border-b border-zinc-100">
        <div className="max-w-[1400px] mx-auto px-6 py-4 flex items-center justify-between">
          <nav className="flex items-center gap-2 text-[14px] text-zinc-500">
            ...
            <ChevronRight size={14} className="text-zinc-300" />
            <span className="hover:text-zinc-900 cursor-pointer">Ridley High Waist</span>
          </nav>
      ...
      <div className="max-w-[1200px] mx-auto px-6 py-10">
        <div className="flex flex-col lg:flex-row gap-12 items-start">
          ...
          {/* Left: Images (Main + Right Side Thumbnails) */}
          <div className="flex w-full lg:w-[48%] gap-4">
             {/* Main Image */}
             <div 
               className="flex-1 relative overflow-hidden bg-zinc-50 group cursor-crosshair order-1"
             ...
             {/* Thumbnails Sidebar (On the RIGHT of Main Image) */}
             <div className="hidden md:flex flex-col gap-3 w-[100px] order-2">
                {productImages.map((img, idx) => (
                  <div 
                    key={idx} 
                    onClick={() => setActiveIndex(idx)}
                    className={`cursor-pointer border-2 transition-all animate-rotate-in-manual ${
          ...
          <div className="w-full lg:w-[52%] lg:sticky lg:top-10 relative">
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="space-y-1 text-[13px] pt-4 border-t border-zinc-50">
                 ...
                 <div><span className="text-zinc-400">Categories:</span> <span className="text-zinc-600">All, Dress, Fashion 2</span></div>
                 <div><span className="text-zinc-400">Tags:</span> <span className="text-zinc-600 italic">Price $7-$50, Vendor Kalles, women</span></div>
              </div>
                ...
                <table className="w-full border-collapse">
                  <tbody>
                    <tr>
                      ...
                      <td className="py-4 px-6">S, M, L</td>
                    </tr>
                  </tbody>
                </table>
              </div>
      ...
      <div className="max-w-[1200px] mx-auto px-6 py-20 border-t border-zinc-100">
        ...
        <div className="relative group/slider">
          <div ref={sliderRef} className="flex gap-6 overflow-x-auto scroll-smooth no-scrollbar scroll-snap-x mandatory py-4">            {[
              ...
              { id: 4, name: 'Summer Shorts', price: 30.00, image1: 'https://kalles-5.myshopify.com/cdn/shop/files/p24-11_ec0dcf2b-dcc4-48cf-8b3e-71c6945984db.jpg?v=1717404614&width=720', sizes: 'S, M, L' },
...
export default ThumbnailcarouselR;
